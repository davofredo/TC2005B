...
public class Main {
     ...
     * Validar si existe el archivo, si existe, preguntar si deseamos eliminar, no
     * existe
     * Ingresar nombre de la carpeta
     * Elegir entre las opciones de extension de archivos: txt, json, properties,
     * yaml
    ...
    public static void main(String[] args) throws IOException {
        ...
        String nombreArchivo = System.console()
                .readLine("Ingrese un nombre de archivo con la extensión .(txt/json/properties, yaml): ");
